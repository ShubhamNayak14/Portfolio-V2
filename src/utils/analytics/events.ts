...
const events = {
  //----------------------------------------------------
  // EVENTS THAT CAN BE CALLED FROM MULTIPLE PLACES
  //----------------------------------------------------
  shared: {
    contactForm: {
      linkedin: () => ({ label: "visit_linkedin" }),
      twitter: () => ({ label: "visit_twitter" }),
      resume: () => ({ label: "view_resume" }),
      github: () => ({ label: "visit_github" }),
      clickEmail: () => ({ label: "click_email" }),
      ...
      submitFormStart: ({
        ...
        label: "submit_form_start",
        parameters: { sender_name, sender_email },
      }),
  ...
  //----------------------------------------------------
  // EVENTS SPECIFIC TO A PAGE
  //----------------------------------------------------
  pages: {
    home: {
      jumpToViewAllSkills: () => ({ label: "jump_to_view_all_skills" }),
      viewMoreProjects: () => ({ label: "view_more_projects" }),
    },
    ...
    letters: {
      viewLetter: ({
        ...
        label: "visit_letter",
        parameters: { link_url, article_title },
      }),
    },
    ...
    blog: {
      clickNavBlogLink: () => ({ label: "nav_blog_link" }),
      clickNavPortfolioLink: () => ({ label: "nav_portfolio_link" }),

      tweetBlogPost: ({ title, url }: { title: string; url: string }) => ({
        label: "tweet_post",
        parameters: { blog_title: title, blog_url: url },
      }),
