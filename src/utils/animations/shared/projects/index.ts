...
// // Utility to restore scrolling (remove scroll locking classes/styles)
...
//       })
//       .add(() => {
//         restoreScroll();          // Restore scrolling on close
//         gsap.globalTimeline.clear(); // Clear pending GSAP animations
//         ScrollTrigger.refresh();  // Refresh ScrollTrigger plugin properly
//       }, "+=0");
